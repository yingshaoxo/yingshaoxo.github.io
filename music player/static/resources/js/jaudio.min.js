! function(t) {
    ...
    i.prototype = {
        ...
        play: function() {
            var t = this,
                i = t.$domControls.find("#btn-play");
            t.domAudio.play(), "play" !== t.currentState && (clearInterval(t.timer), t.timer = setInterval(t.run.bind(t), 50), t.currentState = "play", i.data("action", "pause"), i.attr("id", "btn-pause"), i.toggleClass("active"))
        },
        pause: function() {
            var t = this,
                i = t.$domControls.find("#btn-pause");
        ...
        renderDetails: function() {
            var i = this,
                a = i.settings.playlist[i.currentTrack],
                e = (a.file, a.thumb, a.trackName),
                r = a.trackArtist,
                s = (a.trackAlbum, "");
            s += "<p>", s += "<span>" + e + "</span>", s += "<span>" + r + "</span>", s += "</p>", t(".jAudio--details").html(s)
        },
        renderPlaylist: function() {
            ...
            t.each(i.settings.playlist, function(t, i) {
                ...
                trackDuration = "00:00", a += "<div class='jAudio--playlist-item' data-track='" + e + "'>", a += "<div class='jAudio--playlist-thumb'><img src='" + r + "'></div>", a += "<div class='jAudio--playlist-meta-text'>", a += "<h4>" + s + "</h4>", a += "<p>" + o + "</p>", a += "</div>", a += "</div>"
...
var t = {
    playlist: [{
        file: "./music/Highscore.mp3",
        thumb: "./music/picture/Highscore.jpg",
        trackName: "Highscore",
        trackArtist: "Panda Eyes",
        trackAlbum: "Highscore"
    }]
};
